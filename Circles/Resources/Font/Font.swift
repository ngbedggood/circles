...
struct SatoshiFont {
    ...
    static func font(for textStyle: Font.TextStyle, size: CGFloat, weight: Font.Weight = .regular)
        -> Font
    {
        return .custom("Satoshi Variable", size: size)
            .weight(weight)
...
extension Font {
    ...
    static func satoshi(_ textStyle: Font.TextStyle, size: CGFloat, weight: Font.Weight = .regular)
        -> Font
    {
